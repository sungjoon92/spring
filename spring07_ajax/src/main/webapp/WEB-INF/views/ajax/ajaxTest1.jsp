...
<body>
	...
	● AJAX (Asynchronous JavaScript and XML) - 참조
	  https://www.w3schools.com/js/js_ajax_intro.asp - 참조
	  ...
	  - 자바스크립의XMLHttpRequest객체를 이용하지만, 사용문법이 복잡해서 jQuery 오픈소스의 ajax()함수를 많이 이용한다
